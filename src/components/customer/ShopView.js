                ...
                <form>
                    <div className="container-fluid">
                        <div className="row">
                            ...
                            <div className="col-6">
                                <InputFormGroup inputClassName="form-control" labelClassName="mb-2" isReadOnly={true} value="David" label="First Name" />
                            </div>
                            <div className="col-6">
                                <InputFormGroup inputClassName="form-control" labelClassName="mb-2" isReadOnly={true} value="Bruce" label="Last Name" />
                            </div>
                            <div className="col-6">
                                <InputFormGroup inputClassName="form-control" labelClassName="mb-2" isReadOnly={true} value="bruce08sust@gmail.com" label="Email" />
                            </div>
                            <div className="col-6">
