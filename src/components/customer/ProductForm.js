                ...
                <form>
                    <div className="container-fluid">
                        <div className="row">
                            ...
                            <div className="col-6">
                                <SelectFormGroup labelClassName="mb-2" label="Role" selectClassName="custom-select my-1 mr-sm-2" selectData={productCategory}/>
                            </div>
                            ...
                            <div className="col-12">
                                <div className="form-group form-check">
                                    ...
                                    <label className="form-check-label" htmlFor="publicOnCreation">Make public on creation</label>
                                </div>
                            </div>
